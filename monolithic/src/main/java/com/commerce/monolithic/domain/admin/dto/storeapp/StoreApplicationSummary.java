...
@Getter
@Builder
@Schema(name = "StoreApplicationSummary", description = "매니저 신청 요약")
public class StoreApplicationSummary {
	...
	public static StoreApplicationSummary from(StoreApplication a) {
		return StoreApplicationSummary.builder()
			.id(a.getId())
			.status(a.getStatus())
